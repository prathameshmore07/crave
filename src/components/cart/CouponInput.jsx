...
export default function CouponInput() {
  ...
  // Reset hasManuallyRemoved when subtotal changes (meaning items were added/removed)
  useEffect(() => {
  ...
  useEffect(() => {
    if (!appliedCoupon && subtotal > 0 && !hasManuallyRemoved) {
  ...
  }, [subtotal, appliedCoupon, applyCoupon, hasManuallyRemoved]);
