  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[100] h-16 md:h-20 bg-[--header-bg] backdrop-blur-md border-b border-black/[0.04] dark:border-white/[0.05] select-none transition-colors duration-200">
      <div className="max-w-7xl mx-auto w-full h-full flex items-center justify-between px-4 md:px-8">
        ...
        <div className="hidden md:flex flex-1 max-w-[460px] mx-auto items-center gap-4 bg-black/[0.015] dark:bg-white/[0.02] hover:bg-black/[0.03] dark:hover:bg-white/[0.04] border border-black/[0.04] dark:border-white/[0.05] rounded-full px-4 h-11 transition-all duration-200">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <Link
            to="/membership"
            className={`lg:hidden flex items-center gap-1 shrink-0 rounded-full px-2 h-9 border border-black/[0.06] dark:border-white/[0.08] hover:bg-black/[0.04] dark:hover:bg-white/[0.04] transition-colors ${
