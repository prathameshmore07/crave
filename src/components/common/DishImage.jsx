...
export function getFoodCategoryFallback(name, category) {
  ...
  if (lowercaseName.includes("fried rice") || lowercaseName.includes("rice")) {
    ...
    return "https://images.unsplash.com/photo-1603133872878-685f2086ca77?w=400&auto=format&fit=crop&q=80"; // Veg/Chicken Fried Rice
  }
  ...
  if (lowercaseCategory.includes("fried rice") || lowercaseCategory.includes("rice")) {
    return "https://images.unsplash.com/photo-1603133872878-685f2086ca77?w=400&auto=format&fit=crop&q=80";
  }
