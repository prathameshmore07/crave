              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-semibold text-gray-900 dark:text-gray-100">Wallet</p>
                    ...
                    <div
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                        paymentMethod === 'wallet' ? 'border-brand bg-brand' : 'border-gray-400'
                      }`}
                    >
                      {paymentMethod === 'wallet' && <span className="text-white text-xs">✓</span>}
                    </div>
                  </div>
                </div>
              </div>
